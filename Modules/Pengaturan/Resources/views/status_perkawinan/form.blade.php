        ...
        <form method="post" id="form" action="#" enctype="multipart/form-data">
            ...
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">{{isset($data) && $data->exists()? 'Edit': 'Tambah'}} Status Perkawinan</h3>
                ...
                <div class="block-content">
                    <div class="form-group row" style="margin-bottom: 1.429rem;">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control form-control-sm" id="status_perkawinan" name="status_perkawinan" value="{{ isset($data) && !empty($data->status_perkawinan) ?$data->status_perkawinan:'' }}">
...
<script type="text/javascript">
    ...
    //   })
        ...
        $.ajax({
            url: '{{url('status-perkawinan/send-data')}}',
            type: 'POST',
            data: formData,
            headers: {
