        ...
        <div class="row push">
            <div class="col-md py-10 d-md-flex align-items-md-center text-center">
                <h1 class="text-white mb-0">
                    ...
                    <span class="font-w400 font-size-lg text-white-op d-none d-md-inline-block">Status Perkawinan</span>
                </h1>
            </div>
            <div class="col-md py-10 d-md-flex align-items-md-center justify-content-md-end text-center">
                @can('status-perkawinan-create')
                <a class="btn btn-alt-primary" href="#" onclick="show_modal('{{ route('status-perkawinan.create') }}')">
...
<div class="bg-white">
    ...
    <div class="content">
        <nav class="breadcrumb mb-0">
            ...
            <span class="breadcrumb-item active">Status Perkawinan</span>
        </nav>
        <h2 class="content-heading"></h2>
        <!-- Dynamic Table Full -->
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Status Perkawinan</h3>
            </div>
                ...
                <div class="table-responsive">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th data-field="status_perkawinan">Status Perkawinan</th>
