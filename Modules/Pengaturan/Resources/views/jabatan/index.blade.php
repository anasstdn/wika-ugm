        ...
        <div class="row push">
            <div class="col-md py-10 d-md-flex align-items-md-center text-center">
                <h1 class="text-white mb-0">
                    ...
                    <span class="font-w400 font-size-lg text-white-op d-none d-md-inline-block">Jabatan</span>
                </h1>
            </div>
            <div class="col-md py-10 d-md-flex align-items-md-center justify-content-md-end text-center">
                @can('jabatan-create')
                <a class="btn btn-alt-primary" href="#" onclick="show_modal('{{ route('jabatan.create') }}')">
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Jabatan</h3>
            </div>
