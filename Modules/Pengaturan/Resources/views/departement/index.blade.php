        ...
        <div class="row push">
            <div class="col-md py-10 d-md-flex align-items-md-center text-center">
                <h1 class="text-white mb-0">
                    ...
                    <span class="font-w400 font-size-lg text-white-op d-none d-md-inline-block">Departement</span>
                </h1>
            </div>
            <div class="col-md py-10 d-md-flex align-items-md-center justify-content-md-end text-center">
                @can('departement-create')
                <a class="btn btn-alt-primary" href="#" onclick="show_modal('{{ route('departement.create') }}')">
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Departement</h3>
            </div>
