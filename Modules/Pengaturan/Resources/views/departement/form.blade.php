        ...
        <form method="post" id="form" action="#" enctype="multipart/form-data">
            ...
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">{{isset($data) && $data->exists()? 'Edit': 'Tambah'}} Departement</h3>
                ...
                <div class="block-content">
                    <div class="form-group row" style="margin-bottom: 1.429rem;">
                        <label class="col-form-label col-md-3">Departement</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control form-control-sm" id="departement" name="departement" value="{{ isset($data) && !empty($data->departement) ?$data->departement:'' }}">
...
<script type="text/javascript">
    ...
    function post_data()
    {
        ...
        formData.append('departement', $('#departement').val());
