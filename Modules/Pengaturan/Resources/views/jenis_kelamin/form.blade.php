        ...
        <form method="post" id="form" action="#" enctype="multipart/form-data">
            ...
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">{{isset($data) && $data->exists()? 'Edit': 'Tambah'}} Jenis Kelamin</h3>
                ...
                <div class="block-content">
                    <div class="form-group row" style="margin-bottom: 1.429rem;">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control form-control-sm" id="jenis_kelamin" name="jenis_kelamin" value="{{ isset($data) && !empty($data->jenis_kelamin) ?$data->jenis_kelamin:'' }}">
...
<script type="text/javascript">
    ...
    //   })
        ...
        $.ajax({
            url: '{{url('jenis-kelamin/send-data')}}',
            type: 'POST',
            data: formData,
            headers: {
