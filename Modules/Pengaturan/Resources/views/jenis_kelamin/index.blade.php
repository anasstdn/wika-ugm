        ...
        <div class="row push">
            <div class="col-md py-10 d-md-flex align-items-md-center text-center">
                <h1 class="text-white mb-0">
                    ...
                    <span class="font-w400 font-size-lg text-white-op d-none d-md-inline-block">Jenis Kelamin</span>
                </h1>
            </div>
            <div class="col-md py-10 d-md-flex align-items-md-center justify-content-md-end text-center">
                @can('jenis-kelamin-create')
                <a class="btn btn-alt-primary" href="#" onclick="show_modal('{{ route('jenis-kelamin.create') }}')">
...
<div class="bg-white">
    ...
    <div class="content">
        <nav class="breadcrumb mb-0">
            ...
            <span class="breadcrumb-item active">Jenis Kelamin</span>
        </nav>
