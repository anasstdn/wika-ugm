			...
			<div class="block-content block-content-full">
				...
				<div class="row">
					<div class="col-12 text-right">
						{{-- <a href="{{ url('/verifikasi-po/'.$data->id.'/test-pdf') }}" class="btn btn-alt-info print_pdf" style="display: none" target="_blank">Print PDF</a> --}}
...
<script>
	...
	save_data = () => {
        ...
        formData.append('catatan_project_manager', $('#catatan_project_manager').val());
