				...
				<div class="col-lg-12">
					...
					<div class="js-wizard-validation-classic block">
						...
						<ul class="nav nav-tabs nav-tabs-block nav-fill" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" href="#wizard-progress-data-pribadi" data-toggle="tab">1. Data Pengajuan SPM</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="#wizard-progress-alamat" data-toggle="tab">2. Daftar Material</a>
							</li>
							{{-- <li class="nav-item">
						...
						@else
						{!! Form::open(array('route' => 'spm.store','method'=>'POST','class' => 'js-wizard-validation-classic-form','id'=>'form','files'=>true)) !!}
						@endif
				...
				else
				{
					$('.valid-material').each(function(index,element){
						if($(element).hasClass('valid-material'))
						{
							if($(this).val() == '')
							{
								notification('Silahkan periksa kelengkapan data terlebih dahulu','gagal');
								$('#simpan').html('<i class="fa fa-circle-o-notch fa-spin"><i>').prop('disabled',true);
								err += 1;
							}
						}
