        ...
        <div class="content">
            ...
            <div class="block block-themed">
                ...
                <div class="block-content block-content-full">
                    <div class="table-responsive">
                        <font style="font-size: 11px" face="Arial">
                            <table data-toggle="table" data-ajax="ajaxRequestDiterima" data-search="false"
                                data-side-pagination="server" data-pagination="true"
                                data-page-list="[5,10, 25, 50, 100, 200, All]" data-show-fullscreen="true"
                                data-show-extended-pagination="true"
                                class="table table-bordered table-striped table-vcenter" id="table-diterima">
                                <thead>
                                    <tr>
                                        <th data-field="no">No</th>
                                        <th data-field="no_spm">Nomor SPM</th>
            ...
            <div class="block block-themed">
                ...
                <div class="block-content block-content-full">
                    <div class="table-responsive">
                        <font style="font-size: 11px" face="Arial">
                            <table data-toggle="table" data-ajax="ajaxRequestDitolak" data-search="false"
                                data-side-pagination="server" data-pagination="true"
                                data-page-list="[5,10, 25, 50, 100, 200, All]" data-show-fullscreen="true"
                                data-show-extended-pagination="true"
                                class="table table-bordered table-striped table-vcenter" id="table-ditolak">
                                <thead>
                                    <tr>
                                        <th data-field="no">No</th>
                                        <th data-field="no_spm">Nomor SPM</th>
...
@push('js')
    <script>
        ...
        function ajaxRequestDiterima(params) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('verifikasi-spm/get-data-diterima') }}",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                data: formData,
        ...
        function ajaxRequestDitolak(params) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('verifikasi-spm/get-data-ditolak') }}",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                data: formData,
