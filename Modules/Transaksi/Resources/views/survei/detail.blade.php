		...
		<div class="row push">
			<div class="col-md py-10 d-md-flex align-items-md-center text-center">
				<h1 class="text-white mb-0">
					...
					<span class="font-w400 font-size-lg text-white-op d-none d-md-inline-block">Detail Survei Barang</span>
				</h1>
			</div>
		</div>
	</div>
...
<div class="content">
	<div class="block block-themed">
		<div class="block-header bg-info">
			<h3 class="block-title"><i class="fa fa-user-circle mr-5 text-muted"></i> Detail Survei Barang</h3>
				...
				<div class="col-lg-12">
					<div class="form-row">
						<div class="form-group col-3">
							...
							<input class="form-control form-control-sm" type="text" id="nama" value="{{ isset($data->tgl_pembuatan)?date_indo(date('Y-m-d',strtotime($data->tgl_pembuatan))):'' }}" readonly="">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-3">
					...
					<div class="form-row">
						<div class="form-group col-3">
							...
							<input class="form-control form-control-sm" type="text" id="nama" value="{{isset($data->supplier->nama_supplier)?$data->supplier->nama_supplier:''}}" readonly="">
						</div>
					</div>
					<br>
						...
						<table class="table table-sm" width="100%" id="tabel">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input class="form-control form-control-sm" type="text" name="merek[]" id="merek_{{ $key }}" value="{{ $value->merek }}">
									</td>
									<td>
										<input class="form-control form-control-sm harga hitung number_dot" style="text-align: right" type="text" name="total[]" id="total_{{ $key }}" value="{{ number_format($value->harga_per_unit,0,',','.') }}">
									</td>
									<td>
