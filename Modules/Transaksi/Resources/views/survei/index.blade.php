            ...
            <div class="row push">
                <div class="col-md py-10 d-md-flex align-items-md-center text-center">
                    <h1 class="text-white mb-0">
                        ...
                        <span class="font-w400 font-size-lg text-white-op d-none d-md-inline-block">Survei Barang</span>
                    </h1>
                </div>
                <div class="col-md py-10 d-md-flex align-items-md-center justify-content-md-end text-center">
                    @can('survei-create')
                        <a class="btn btn-alt-primary" href="{{ route('survei.create') }}">
                            <i class="fa fa-plus mr-5"></i> Tambah Survei Baru
                        </a>
                    @endcan
                </div>
            </div>
        ...
        <div class="content">
            <div class="block block-themed">
                <div class="block-header bg-primary">
                    <h3 class="block-title">Survei Barang</h3>
                ...
                <div class="block-content block-content-full">
                    <div class="form-row">
                        <div class="form-group col-3">
                            ...
                            <select class="select form-control" name="supplier_id" id="supplier_id" style="width: 100%;"
                                data-placeholder="">
                                <option value="">-Silahkan Pilih-</option>
                                @if (isset($supplier) && !$supplier->isEmpty())
                                    @foreach ($supplier as $key => $val)
                                        <option value="{{ $val->id }}">{{ $val->kode_supplier }} -
                            ...
                            <select class="select form-control" name="material_id" id="material_id" style="width: 100%;"
                                ...
                                @if (isset($material) && !$material->isEmpty())
                                    @foreach ($material as $key => $val)
                                        <option value="{{ $val->id }}">{{ $val->kode_material }} -
                                            {{ $val->material }}</option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="table-responsive">
                        <font style="font-size: 11px" face="Arial">
                            <table data-toggle="table" data-ajax="ajaxRequest" data-search="false"
                                ...
                                class="table table-bordered table-striped table-vcenter" id="table">
                                <thead>
                                    <tr>
