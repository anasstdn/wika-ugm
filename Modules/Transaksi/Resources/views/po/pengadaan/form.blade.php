		...
		<div class="row push">
			<div class="col-md py-10 d-md-flex align-items-md-center text-center">
				<h1 class="text-white mb-0">
					...
					<span class="font-w400 font-size-lg text-white-op d-none d-md-inline-block">Daftar Survei Barang</span>
				</h1>
			</div>
		</div>
	</div>
...
<div class="content">
	<div class="block block-themed">
		<div class="block-header bg-info">
			<h3 class="block-title"><i class="fa fa-user-circle mr-5 text-muted"></i> Daftar Survei Barang</h3>
			...
			<div class="row items-push">
				<div class="col-lg-12">
					...
					<div id="table_data" style="font-family: sans-serif;">
						@include('transaksi::po.pengadaan.form-data')
					</div>
...
<script>
	...
	const load_table = (page,method,params = {}) =>{
		return new Promise((resolve, reject) => {
			...
			$.ajax({
				url : '{{ url('po/load-table') }}?page='+page,
				type: method,
