        ...
        MAIN CONTENT LAYOUT
          ...
          <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
              ...
              <!-- Page Content -->
              <div class="bg-body-dark bg-pattern" style="background-image: url('{{asset('codebase/')}}/src/assets/media/various/bg-pattern-inverse.png');">
                          ...
                          <div class="block-content">
                            <div class="form-group row {{$errors->has('username') || $errors->has('email')?'has-error':''}}">
                              <div class="col-12">
                                ...
                                <input type="text" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" name="email" value="{{ old('username')?:old('email') }}">
